...
Run all three subagents **simultaneously**. Each agent receives the list of changed files relevant to its domain, the review parameters, and must write its review to a markdown file.
