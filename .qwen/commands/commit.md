---
name: commit
description: "Analyze the current repository state, group changes by goal, and create one or multiple clear conventional commits (with Gitmoji). Ask for a short human summary when needed."
---
