...
- `.github/instructions/frontend-react-typescript.instructions.md`
- `.github/copilot-instructions.md` (Language Requirements and Conventions sections)
...
- ONLY work within the `frontend/` directory and related config files (`docker-compose.yml` frontend service, `.github/instructions/frontend-*`)
